    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
      <main className="flex-1 max-w-[1440px] mx-auto p-6 md:p-12 w-full animate-in fade-in duration-700">
        ...
        <header className="mb-14 border-b-4 border-navy pb-10">
          <div className="flex items-center gap-4 mb-4">
             <div className="w-3 h-10 bg-navy"></div>
             <h1 className="text-5xl font-black tracking-tight text-navy uppercase leading-none">{categoryName}.</h1>
          </div>
          <p className="text-gray-500 font-bold uppercase tracking-widest px-7">
      ...
      <footer className="bg-white border-t-2 border-gray-100 py-10 px-6 md:px-12 mt-20">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <p className="text-[10px] text-gray-300 font-black uppercase tracking-widest">© 2026 GOVRECRUIT SYSTEM — OFFICIAL ARCHIVE</p>
        </div>
      </footer>
    </div>
  );
