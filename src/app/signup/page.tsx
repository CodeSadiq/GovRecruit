              ...
              <div>
                ...
                <div className="relative group/field">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full bg-white border-2 border-gray-100 py-3.5 md:py-4 pl-11 md:pl-12 pr-12 text-[14px] md:text-[15px] font-sans font-medium text-navy placeholder:text-navy/30 rounded-xl md:rounded-2xl focus:outline-none focus:border-navy transition-all shadow-sm focus:shadow-md"
                  />
                  <button
                    type="button"
