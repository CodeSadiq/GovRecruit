              ...
              <aside className="space-y-8">
                <div className="bg-white border-2 border-gray-100 p-6 shadow-sm">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-[12px] font-black uppercase tracking-widest text-[#0D244D] flex items-center gap-2">
                      <IconBell /> Notifications
                    </h3>
                    <Link href="/notifications" className="text-[10px] font-black uppercase tracking-[0.2em] text-[#2563EB] hover:text-[#1d4ed8] transition-colors no-underline">
                      View All ›
                    </Link>
                  </div>
                  <div className="space-y-5">
                    {NOTIFICATIONS.slice(0, 4).map((n, i) => (
                      <div key={i} className="group cursor-default">
                        <div className="text-[14px] font-medium text-gray-700 leading-snug group-hover:text-[#2563EB] transition-colors mb-1">{n.text}</div>
                        <div className="text-[10px] font-bold uppercase tracking-widest text-gray-400">{n.time}</div>
                      </div>
                    ))}
                  </div>
                </div>
