...
export const QUAL_TREE: QualNode[] = [
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "Nalkoop Mechanic",
        label: "Nalkoop Mechanic"
      },
      {
        value: "Refrigeration and AC",
        label: "Refrigeration and AC"
      },
      {
        value: "Heat Engine",
        label: "Heat Engine"
      ...
      {
        value: "Mechanic Diesel",
        label: "Mechanic Diesel"
      },
      {
        value: "Armature and Coil Winder",
        label: "Armature and Coil Winder"
      },
      {
      ...
      {
        value: "Mechanic Radio and TV",
        label: "Mechanic Radio and TV"
      },
      {
      ...
      {
        value: "Electronics Mechanic",
        label: "Electronics Mechanic"
      },
      {
        value: "Instrument Mechanic",
        label: "Instrument Mechanic"
      },
      {
        value: "Mechanic Consumer Electronics",
        label: "Mechanic Consumer Electronics"
      },
      {
      ...
      },
      {
        ...
        label: "Mechanic Machine Tools Maintenance"
      },
      {
        value: "Motor Mechanic",
        label: "Motor Mechanic Vehicle (MMV)"
      },
      {
      ...
      {
        value: "Mechanic Two Wheeler",
        label: "Mechanic Two Wheeler"
      },
      {
        value: "Refrigeration and AC Mechanic",
        label: "Refrigeration & AC Mechanic"
      },
      {
        value: "Draughtsman Civil",
        label: "Draughtsman Civil"
      },
      {
        value: "Mason",
        label: "Mason (Construction)"
      },
      {
        value: "Plumber",
        label: "Plumber"
      ...
      },
      {
        ...
        label: "Interior Decoration & Design"
      },
      {
        value: "Draughtsman Mechanical",
        label: "Draughtsman Mechanical"
      },
      {
        value: "COPA",
        label: "COPA (Computer Operator & Programming)"
      },
      {
        value: "Mechanic Computer Hardware",
        label: "Mechanic Computer Hardware & Networking"
      },
      {
        value: "IT and ITES",
        label: "IT & ITES"
      },
      {
        ...
        label: "Rubber Technician"
      },
      {
        value: "Leather Goods Maker",
        label: "Leather Goods Maker"
      },
      {
        value: "Cutting and Sewing",
        label: "Cutting and Sewing"
      },
      {
        value: "Dress Making",
        label: "Dress Making"
      ...
      {
        value: "Embroidery",
        label: "Embroidery and Needle Work"
      },
      {
        value: "Book Binder",
        label: "Book Binder"
      ...
      {
        value: "Stenographer",
        label: "Stenographer (English/Hindi)"
      },
      {
        value: "Photographer",
        label: "Photographer"
      ...
      {
        value: "Physiotherapy Technician",
        label: "Physiotherapy Technician"
      },
      {
      ...
      {
        value: "Health Sanitary Inspector",
        label: "Health Sanitary Inspector"
      },
      {
        value: "Bleaching and Dyeing",
        label: "Bleaching and Dyeing Calico Print"
      },
      {
        value: "Hair and Skin Care",
        label: "Hair and Skin Care (Cosmetology)"
      },
      {
        value: "Food Production",
        label: "Food Production (General)"
      },
      {
        value: "Bakery and Confectionery",
        label: "Bakery and Confectionery"
      },
      {
        value: "Horticulture",
        label: "Horticulture"
      ...
      {
        value: "Lift Mechanic",
        label: "Lift and Escalator Mechanic"
      }
    ]
  },
  {
    ...
    branches: [
      ...
      {
        value: "Public Health Engineering",
      ...
      {
        value: "Aerospace",
        label: "Aeronautical / Aerospace Engineering"
      },
      {
        value: "Architecture",
        label: "Architecture & Town Planning"
      },
      {
      ...
      {
        value: "Medical Lab Technology",
        label: "Medical Lab Technology (DMLT)"
      },
      {
        value: "Radiology and Imaging",
      ...
      {
        value: "Dental Mechanics",
        label: "Dental Mechanics / Dental Technology"
      },
      {
        value: "Dialysis Technology",
        label: "Dialysis Technology"
      },
      {
        value: "Cardiac Technology",
        label: "Cardiac & Perfusion Technology"
      },
      {
      ...
      },
      {
        ...
        label: "Medical Records & Health Information"
      },
      {
        value: "Hotel Management",
        label: "Hotel Management & Catering"
      },
      {
      ...
      },
      {
        ...
        label: "Fashion Design & Technology"
      },
      {
        value: "Graphic Design",
        label: "Graphic Design & Multimedia"
      },
      {
        value: "Printing Technology",
        label: "Printing Technology"
      ...
      {
        value: "Agriculture",
        label: "Agriculture (Diploma)"
      },
      {
        value: "Horticulture",
        label: "Horticulture (Diploma)"
      },
      {
        value: "Forestry",
        label: "Forestry (Diploma)"
      },
      {
        value: "Dairy Technology",
        label: "Dairy Technology (Diploma)"
      },
      {
        value: "Food Technology",
        label: "Food Technology (Diploma)"
      },
      {
        value: "Library Science",
        label: "Library Science (Diploma)"
      },
      {
      ...
      },
      {
        ...
        label: "Physical Education (Diploma)"
      },
      {
        value: "Fire and Safety",
        label: "Fire & Industrial Safety"
      },
      {
        value: "Computer Applications",
        label: "Computer Applications (DCA / PGDCA)"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "Genetics and Plant Breeding",
      ...
      {
        value: "Biochemistry",
        label: "Agricultural Biochemistry"
      },
      {
        value: "Agribusiness",
  ...
  },
  {
    level: 4,
    name: "B.V.Sc",
    label: "B.V.Sc & AH (Veterinary Science)",
    branches: [
      {
  ...
  },
  {
    level: 4,
    name: "B.F.Sc",
    label: "B.F.Sc (Fisheries Science)",
    branches: [
      {
        value: "Fisheries Science",
  ...
  },
  {
    level: 4,
    name: "B.H.M",
    label: "BHM / BHMCT (Hotel Management)",
    branches: [
      {
        value: "Hotel Management",
  ...
  },
  {
    level: 4,
    name: "BJMC",
    label: "BJMC / BMC (Mass Communication)",
    branches: [
      {
        value: "Journalism",
        label: "Journalism"
      ...
      },
      {
        ...
        label: "Electronic Media / Broadcasting"
      }
    ]
  },
  {
    ...
    branches: [
      ...
      {
        value: "Medical Social Work",
        label: "Medical & Psychiatric Social Work"
      }
    ]
  },
  {
    level: 4,
    name: "B.Lib",
    label: "B.Lib.I.Sc (Library Science)",
    branches: [
      {
        value: "Library Science",
  ...
  },
  {
    level: 4,
    name: "B.P.Ed",
    label: "B.P.Ed (Physical Education)",
    branches: [
      {
        value: "Physical Education",
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "UI/UX Design",
        label: "UI/UX / Interaction Design"
      },
      {
        value: "Textile Design",
        label: "Textile / Apparel Design"
      },
      {
        value: "Animation",
  ...
  },
  {
    ...
    branches: [
      {
        value: "CMA",
        label: "Cost & Management Accountancy"
      }
    ]
  },
  {
  ...
  },
  {
    level: 4,
    name: "BMLT",
    label: "BMLT (Medical Lab Technology)",
    branches: []
  },
  {
    level: 4,
    ...
    branches: [
      ...
      },
      {
        ...
        label: "Network Engineering / Telecom"
      },
      {
        value: "VLSI",
        label: "VLSI Design / Microelectronics"
      },
      {
      ...
      },
      {
        ...
        label: "Geo-informatics / Geomatics"
      },
      {
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "Zoology",
        label: "Zoology / Animal Science"
      },
      {
        value: "Botany",
        label: "Botany / Plant Science"
      },
      {
        value: "Microbiology",
        label: "Microbiology"
      ...
      },
      {
        ...
        label: "Computer Science (B.Sc CS)"
      },
      {
        value: "Electronics",
        label: "Electronics (B.Sc)"
      },
      {
      ...
      {
        value: "Dairy Science",
        label: "Dairy Science / Technology"
      },
      {
        value: "Fisheries Science",
        label: "Fisheries Science"
      ...
      },
      {
        ...
        label: "Medical Imaging Technology"
      },
      {
        value: "Physiotherapy",
        label: "Physiotherapy (B.Sc)"
      },
      {
        value: "Optometry",
        label: "Optometry (B.Sc)"
      },
      {
        value: "Cardiac Technology",
      ...
      {
        value: "Medical Lab Technology",
        label: "Medical Lab Technology (B.Sc MLT)"
      },
      {
        value: "Nursing",
  ...
  },
  {
    ...
    branches: [
      ...
      },
      {
        ...
        label: "Environmental Studies (BA)"
      }
    ]
  },
  {
    ...
    branches: [
      ...
      {
        value: "Computer Applications",
        label: "Computer Applications (B.Com CA)"
      }
    ]
  },
  {
    ...
    branches: [
      ...
      },
      {
        ...
        label: "AI & Data Science (BCA)"
      },
      {
        value: "Cloud Computing",
        label: "Cloud Computing (BCA)"
      },
      {
        value: "Cyber Security",
        label: "Cyber Security (BCA)"
      }
    ]
  },
  {
    ...
    branches: [
      ...
      {
        value: "Hotel Management",
        label: "Hotel / Hospitality Management"
      },
      {
  ...
  },
  {
    level: 4,
    name: "BAMS",
    label: "BAMS (Ayurvedic Medicine & Surgery)",
    branches: []
  },
  {
    level: 4,
  ...
  },
  {
    level: 4,
    name: "BSMS",
    label: "BSMS (Siddha Medicine & Surgery)",
    branches: []
  },
  {
    level: 4,
    name: "BNYS",
    label: "BNYS (Naturopathy & Yogic Sciences)",
    branches: []
  },
  {
    level: 4,
  ...
  },
  {
    level: 4,
    name: "MBBS",
    label: "MBBS (Medicine & Surgery)",
    branches: []
  },
  {
    level: 5,
    name: "M.Lib",
    label: "M.Lib.I.Sc (Library Science PG)",
    branches: [
      {
        value: "Library Science",
        label: "Library & Information Science"
  ...
  },
  {
    level: 5,
    name: "M.P.Ed",
    label: "M.P.Ed (Physical Education PG)",
    branches: [
      {
        value: "Physical Education",
        label: "Physical Education"
  ...
  },
  {
    level: 5,
    name: "MJMC",
    label: "MJMC / MMC (Mass Communication PG)",
    branches: [
      {
        value: "Journalism",
        label: "Journalism"
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "Dance",
        label: "Dance / Performing Arts (MA)"
      },
      {
        value: "Archaeology",
        label: "Archaeology"
  ...
  },
  {
    ...
    branches: [
      ...
      },
      {
        ...
        label: "Labour Welfare & Personnel Management"
      },
      {
        value: "Criminology",
        label: "Criminology & Correctional Administration"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "AI and Data Science",
        label: "AI & Data Science (MCA)"
      },
      {
        value: "Cyber Security",
        label: "Cyber Security (MCA)"
      },
      {
        value: "Cloud Computing",
        label: "Cloud Computing (MCA)"
      },
      {
        value: "Software Engineering",
        label: "Software Engineering (MCA)"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "Food Technology",
        label: "Food Technology / Science"
      },
      {
        value: "Agriculture",
        label: "Agriculture Science (M.Sc)"
      },
      {
        value: "Horticulture",
        label: "Horticulture (M.Sc)"
      },
      {
        value: "Electronics",
        label: "Electronics (M.Sc)"
      },
      {
        value: "Industrial Chemistry",
        label: "Industrial / Applied Chemistry"
      },
      {
        value: "Data Science",
      ...
      {
        value: "AI",
        label: "Artificial Intelligence (M.Sc)"
      },
      {
  ...
  },
  {
    ...
    branches: [
      ...
      {
        value: "Information Technology",
        label: "IT & Systems Management"
      },
      {
        value: "Hospital Management",
        label: "Hospital & Health Management"
      },
      {
        value: "International Business",
        label: "International Business"
      },
      {
        ...
        label: "Rural & Agribusiness Management"
      },
      {
      ...
      {
        value: "Hotel Management",
        label: "Hotel & Hospitality Management (MBA)"
      },
      {
        value: "Aviation Management",
        label: "Aviation Management (MBA)"
      },
      {
        value: "Retail Management",
        label: "Retail Management (MBA)"
      },
      {
        value: "Public Policy",
