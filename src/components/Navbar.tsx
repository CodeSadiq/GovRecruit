  ...
  return (
    <nav className="bg-[#0D244D] h-[60px] flex items-center px-6 md:px-12 sticky top-0 z-[100] shadow-sm transform-gpu transition-none">
      ...
      <Link href="/" className="flex items-center gap-3 no-underline mr-auto group transition-none">
        ...
        <strong className="text-white text-xl font-serif font-bold leading-none tracking-tight">GovRecruit</strong>
      </Link>
      ...
      <div className="flex items-center gap-4 ml-10">
        {!isLoggedIn ? (
          <Link
            href="/login"
            className="bg-white/10 hover:bg-white text-white hover:text-[#0D244D] border border-white/20 px-6 py-2.5 rounded-xl transition-all text-[15px] font-serif font-bold no-underline active:scale-95"
          >
            Candidate Login
          </Link>
        ) : (
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[15px] font-serif font-bold truncate max-w-[100px]">
